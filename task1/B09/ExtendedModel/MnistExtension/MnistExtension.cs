...
{
    public partial class MnistExtension
    {
        const string modelName = "MnistExtension";
        ...
        /// <summary>
        /// Returns an instance of MnistExtension model.
        /// </summary>
        public MnistExtension()
        {
            string codeBase = Assembly.GetExecutingAssembly().CodeBase;
            UriBuilder uri = new UriBuilder(codeBase);
            string dllpath = Uri.UnescapeDataString(uri.Path);
            string modelpath = Path.Combine(Path.GetDirectoryName(dllpath), "MnistExtension");
        ...
        /// <summary>
        /// Returns instance of MnistExtension model instantiated from exported model path.
        /// </summary>
        /// <param name="path">Exported model directory.</param>
        public MnistExtension(string path)
        {
            manager = new ModelManager(path, true);
            manager.InitModel(modelName, int.MaxValue);
        }
        ...
        /// <summary>
        /// Runs inference on MnistExtension model for a batch of inputs.
